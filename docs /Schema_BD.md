...
- **condominios ↔ gerente**: relação N:1. Um condomínio pode ter um gerente, e um gerente pode ter varios condominios
- **condominios ↔ sindico**: relação N:1. Um condomínio pode ter um sindico, e um sindico pode ter varios condominios
